  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-5 mt-15 md:mt-0 ">
          {activeTab === "profile" && (
            <div>
      ...
      <section>
        ...
        <div className="bg-white p-4 md:p-6 rounded-2xl shadow-xl overflow-x-auto bg-gradient-to-r from-green-100 to-yellow-100 ">
          <table className="min-w-full text-sm text-gray-700 ">
            ...
            <tbody className="divide-y divide-gray-200">
              {orders.map((order) => (
                <tr
                  key={order.id}
                  className="hover:bg-green-100 hover:scale-[1.01] transition-transform duration-200"
                >
...
{/* setting section */}
          ...
          {activeTab === "settings" && (
            <div className="animate-fadeInUp">
              ...
              <div className="bg-gradient-to-br from-green-100 to-green-50 p-6 rounded-2xl shadow-lg space-y-6 bg-gradient-to-r from-green-100 to-yellow-100">
